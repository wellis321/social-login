            ...
            <div class="platform-selection">
                ...
                <div class="platform-grid">
                    ...
                    <a href="instagram.php" class="platform-card instagram">
                        <div class="platform-icon" style="width: 80px !important; max-width: 80px !important; min-width: 80px !important; font-size: 1em !important; flex: 0 0 80px !important;">
                            <img src="assets/images/instagram-logo.png" alt="Instagram" class="instagram-logo-img" style="width: 64px !important; height: 64px !important; max-width: 64px !important; max-height: 64px !important; min-width: 64px !important; min-height: 64px !important; flex: 0 0 64px !important; display: block !important;">
                        </div>
                        <h3>Instagram</h3>
